    ...
    public class SharpUpdater
    {
        ...
        private void bgWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
			...
			if (!e.Cancelled)
			{
				...
				MessageBox.Show("Не найдена информация об обновлении");
        }
        ...
        private void DownloadUpdate(SharpUpdateXml update)
        {
            ...
            {
                MessageBox.Show("Обновление было преравано.\nПрограмма не будет обновлена.", "Отмена обновления", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Была обнаружена ошибка загрузки обновления.\nПожалуйста, попробуйте позже.", "Ошибка загрузки обновления", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
